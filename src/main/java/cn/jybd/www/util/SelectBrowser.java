 ...
 * @param //browser 接收一个字符串,用来表示浏览器的类型
 *      * 其中browserName="chrome"，那么返回一个Chrome浏览器
 *      * browserName="firefox",那么返回一个火狐浏览器
 *      * browserName='ie64',返回64位的ie浏览器
 *      * browserName=‘ie32’，那么返回32位ie浏览器
 *      * browserName='edge',返回Edge浏览器
 *      * @return
 */
...
//        String driverConfgFilePath = "config"+ File.separatorChar+"driver.properties";
